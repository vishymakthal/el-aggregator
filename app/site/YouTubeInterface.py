...
'''
Does a YouTube query of the passed in player name plus "highlights", pulling a
...
'''
def searchYouTubeByPlayerName(player_name,club):
    url = "https://www.googleapis.com/youtube/v3/search?q=" + '{}%20{}'.format(player_name.replace(' ',"%20"),club.replace(' ',"%20")) + "%20highlights&maxResults=5&part=snippet&key=" + CREDENTIALS.yt_key
    print(url)
