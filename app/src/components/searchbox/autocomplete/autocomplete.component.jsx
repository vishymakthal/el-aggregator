        ...
        <div className='searchResults'>      
          {hits.map(hit => (
            <div className='searchResult'>
              <img alt={hit.short_name} src={`${process.env.REACT_APP_API_URL}/api/v1/images/${hit.sofifa_id}?q=player`}/>
    ...
    return(
      <div className='autoComplete'>  
        ...
        <div className='searchResults'>      
          {hits.map(hit => (
            <div className='searchResult'>
              <img alt={hit.name} src={`${process.env.REACT_APP_API_URL}/api/v1/images/${hit.ext}?q=team`}/>
